  ...
  class EventType
    ...
    def list(options = {})
      ...
      res = @client.execute_request(
        "GET",
        path,
        query_params: { "limit" => options["limit"], "iterator" => options["iterator"], "order" => options["order"], "include_archived" => options["include_archived"], "with_content" => options["with_content"] },
      )
    ...
    def delete(event_type_name, options = {})
      ...
      res = @client.execute_request(
        "DELETE",
        path,
        query_params: { "expunge" => options["expunge"] },
      )
    end
